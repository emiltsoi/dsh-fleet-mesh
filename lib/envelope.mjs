// dsh-mesh — the bracketed mesh envelope.
//
...
export function wireBody(from, envelopeText) {
	// sort_keys=True on the sender (session_relay.py L362) — key order is part of
	// the bytes, and the signature covers the bytes.
	return JSON.stringify({ from, text: envelopeText }, ['from', 'text']);
}
